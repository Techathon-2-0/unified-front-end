  ...
  const tripStatusCards = [
    {
      ...
      isSelected: Array.isArray(selectedStatus) && selectedStatus.join() === ["p","d","t"].join(),
    },
    {
      title: "Inactive",
    ...
    <div className="px-6 py-4 space-y-8">
      ...
      <div>
        ...
        ">
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Alarm Status</h3>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6">
