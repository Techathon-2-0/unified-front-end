...
const VendorAnalytics: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden h-[500px] flex flex-col backdrop-blur-sm">
      ...
      <div className="bg-gradient-to-r from-purple-50 via-pink-50 to-indigo-50 dark:bg-gradient-to-r dark:from-purple-900/10 dark:via-pink-900/10 dark:to-indigo-900/10 p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700 flex-shrink-0">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center space-x-3">
            <div className="p-2 bg-purple-100 dark:bg-purple-900/30 rounded-xl border border-purple-200 dark:border-purple-800">
              <Building2 className="text-purple-600 dark:text-purple-400" size={20} />
            </div>
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white text-lg">Vendor Performance</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Partner analytics & monitoring</p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            <Badge variant="outline" className="bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 border-green-200 dark:border-green-700">
              {operationalCount}/{vendors.length} Operational
            </Badge>
            <Link to="/live/list">
              <button className="flex items-center space-x-2 px-4 py-2 bg-red-600 dark:bg-red-600 text-white rounded-xl hover:bg-red-700 dark:hover:bg-red-700 transition-all duration-200 shadow-md text-sm font-medium hover:scale-105 active:scale-95">
                <span>View All</span>
      ...
      {/* Scrollable Table with enhanced dark mode */}
      <ScrollArea className="flex-1">
        <div className="min-w-full">
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-900/50 sticky top-0 z-10 backdrop-blur-sm">
              <tr>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">
                  Vendor
                </th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">
                  Status
              ...
              {vendors.slice(0,4).map((vendor: any) => (
                ...
                >
                  <td className="px-4 py-4">
                    <div className="flex items-center space-x-3">
                      <div className="p-2 bg-gray-100 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 group-hover:border-gray-300 dark:group-hover:border-gray-500 transition-colors">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400">Logistics Partner</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-4">
                  ...
                  <td className="px-4 py-4">
                    <div className="space-y-1">
                      <div className="text-sm font-medium text-gray-900 dark:text-white">{vendor.vehicles} vehicles</div>
                      <div className="flex space-x-2 text-xs flex-wrap">
                        <span className="text-green-600 dark:text-green-400 font-medium">{vendor.active} active</span>
                        <span className="text-yellow-600 dark:text-yellow-400 font-medium">{vendor.noUpdate} no update</span>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-4">
                    <div className="flex items-center space-x-2">
                      <div className="w-16 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden border border-gray-300 dark:border-gray-600">
                        <div
                      ...
                      <span className="text-xs text-gray-600 dark:text-gray-300 font-medium">{vendor.efficiency}%</span>
                    </div>
                  </td>
                  <td className="px-4 py-4">
                    <Badge
      ...
      <div className="p-4 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          ...
          <Link to="/live/list">
            <button className="text-sm text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium transition-colors hover:scale-105 active:scale-95 flex items-center space-x-1 group">
