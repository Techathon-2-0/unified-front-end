...
import type { EntityTableProps } from "../../../types/manage/entity"
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50 sticky top-0 z-10">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-500 lg:pl-0">Entity ID</th>
                <th
                  ...
                  {sortedEntities.map((entity, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{entity.vehicleNumber}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-500">{formatDate(entity.createdAt)}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-500">{formatDate(entity.updatedAt)}</div>
                      </td>
                    </motion.tr>
                  ))}
                </AnimatePresence>
