...
import { fetchEntities } from "../../../data/manage/group"
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex items-center justify-center min-h-screen p-4">
            ...
            >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-2 items-center">
                          <button
                            ...
                            className="px-3 py-1 text-xs bg-black dark:bg-gray-700 text-white rounded hover:bg-gray-800 dark:hover:bg-gray-600"
                          ...
                          <button
                            ...
                            className="px-3 py-1 text-xs bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-200 rounded hover:bg-gray-300 dark:hover:bg-gray-500"
                            disabled={isLoadingEntities}
                          >
                            Deselect All
                          </button>
              ...
              <div className="px-6 py-4 bg-gray-50 dark:bg-gray-900 flex flex-col sm:flex-row justify-between rounded-b-xl border-t border-gray-200 dark:border-gray-700 sticky bottom-0">
                <button
                  type="button"
                  onClick={() => {
                    setName("")
                  ...
                  className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none transition-colors mb-3 sm:mb-0"
                >
                  Reset
                </button>
                <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                  ...
                  <button
                    ...
                    className="px-5 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-black dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                  >
