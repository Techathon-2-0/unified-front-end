...
import { Layers, Maximize2, RotateCcw, Search, Info } from "lucide-react"
...
export function TripMap({ trips, selectedTrip, mapMode }: TripMapProps) {
  ...
  return (
    <div className="flex h-[500px] gap-4">
      {/* Trip List Sidebar */}
      <div className="w-80 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden flex flex-col">
      ...
      {/* Map Container */}
      <div className="flex-1 relative bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden z-10">
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2 z-[1000]">
          <Button
            ...
            className="bg-white/90 dark:bg-gray-800/90 hover:bg-white dark:hover:bg-gray-700 shadow-md border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200"
          >
        ...
        {/* Map Legend */}
        <div className="absolute bottom-4 left-4 bg-white/90 dark:bg-gray-800/90 rounded-lg shadow-md p-3 z-[1000]">
        ...
        {/* Map Info */}
        <div className="absolute top-4 left-4 bg-white/90 dark:bg-gray-800/90 rounded-lg shadow-md p-3 z-[1000]">
