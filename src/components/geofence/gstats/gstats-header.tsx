...
export function GeofenceHeader({
  ...
  return (
    <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-4 relative z-10">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4 relative z-10">
          ...
          <Select value={matrixType} onValueChange={onMatrixTypeChange}>
            <SelectTrigger className="w-48 relative z-50 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200">
              <SelectValue />
            </SelectTrigger>
            <SelectContent className="relative z-50 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200">
              <SelectItem value="geofence" className="dark:hover:bg-gray-700">
                Geofence Matrix
              </SelectItem>
              <SelectItem value="distance" className="dark:hover:bg-gray-700">
                Distance Matrix
              </SelectItem>
            </SelectContent>
          </Select>
