...
import type { Entity, Vendor } from "../../../types/manage/entity"
import {
  fetchEntities,
  createEntity,
  updateEntity,
          ...
          <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
              ...
              >
                ...
                <Input
                  ...
                  className="pl-9 w-full lg:w-[300px] border-slate-300 rounded-full h-11"
                  value={searchQuery}
              ...
              <div className="flex flex-wrap gap-2 w-full lg:w-auto">
                {/* Refresh Button */}
                <Button variant="outline" onClick={handleRefresh} disabled={isRefreshing} className="rounded-md h-11">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline" className="rounded-md h-11">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuItem onClick={handleBulkUpload}>Upload CSV File</DropdownMenuItem>
                    <DropdownMenuItem onClick={downloadTemplate}>Download Template</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
                ...
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                  <Button
                    ...
                    className="bg-black hover:bg-gray-800 text-white border-0 rounded-md h-11"
                  >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
              <div className="text-sm font-medium px-3 sm:px-4 py-1 sm:py-2 rounded-full sm:text-sm">
                <Badge variant="outline" className="bg-red-50 text-red-700 text-base border-red-200 px-4 py-2">
                  Total Count: <span className="font-bold ml-1">{entities.length}</span>
                </Badge>
              </div>
                ...
                <div className="flex flex-wrap gap-2 items-center">
                  ...
                  {activeFilters.map((filter) => (
                    <Badge
                      key={filter.type}
                      variant="secondary"
                      className="bg-blue-100 text-blue-800 hover:bg-blue-200 cursor-pointer text-base px-3 py-1"
