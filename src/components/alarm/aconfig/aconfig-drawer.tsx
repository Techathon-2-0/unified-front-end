                ...
                <div className="px-6 py-4 bg-gray-50 dark:bg-gray-900 flex flex-col sm:flex-row justify-between rounded-b-xl border-t border-gray-200 dark:border-gray-700 sticky bottom-0">
                  ...
                  <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                    ...
                    <button
                      ...
                      className="px-5 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-black dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 focus:outline-none transition-colors"
                    >
