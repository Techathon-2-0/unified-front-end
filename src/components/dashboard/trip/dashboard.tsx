...
export default function TripDashboard() {
  ...
  const handleStatusClick = (status: string) => {
    ...
    switch (status) {
      case "pickup":
        setStatusCardFilter("p");
        break;
      case "delivery":
        setStatusCardFilter("d");
        break;
      case "transit":
        setStatusCardFilter("t");
        break;
      case "inactive":
        setStatusCardFilter("inactive");
        break;
      case "active":
        setStatusCardFilter(["p", "d", "t"]);
        break;
      case "ontime":
        setStatusCardFilter("ontime");
        break;
      case "delayed":
        setStatusCardFilter("delayed");
        break;
      default:
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <div className="p-6">
          {viewMode === "list" ? (
            ...
            <TripMap trips={filteredTrips} selectedTrip={selectedTrip} mapMode={mapMode} setMapMode={setMapMode} />
          )}
        </div>
      </motion.div>
      {Toaster}
