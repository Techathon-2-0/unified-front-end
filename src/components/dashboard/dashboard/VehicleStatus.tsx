...
const VehicleStatus: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden h-[500px] flex flex-col backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-600">
      ...
      <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-purple-900/20 p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700 flex-shrink-0">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white text-lg">Fleet Status</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Real-time vehicle monitoring</p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            ...
            <Link to="/live/list">
              <button className="flex items-center space-x-2 px-4 py-2 bg-red-600 text-white rounded-xl hover:bg-red-700 hover:scale-105 active:scale-95 transition-all duration-200 shadow-md text-sm font-medium">
                <span>View All</span>
                ...
                >
                  <td className="px-4 py-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-gray-900 dark:text-white">{vehicle.vehicleNumber}</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">{vehicle.deviceName}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-4">
                  ...
                  <td className="px-4 py-4">
                    <div>
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">{vehicle.driverMobile}</div>
                    </div>
                  </td>
                  <td className="px-4 py-4">
      ...
      {/* Footer */}
      <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 border-t border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          <span className="text-sm text-gray-600 dark:text-gray-400">{totalCount} vehicles total</span>
          <Link to="/live/vehicles">
            <button className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:scale-105 active:scale-95 font-medium transition-all duration-200">
              View Details →
            </button>
          </Link>
        </div>
