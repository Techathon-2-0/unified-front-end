  ...
  return (
    <div className="flex min-h-screen flex-col w-full overflow-x-hidden bg-white">
        ...
        <div className="w-full flex h-16 lg:h-20 items-center justify-between px-4 lg:px-8">
          ...
          <nav className="hidden lg:flex gap-8 xl:gap-12 flex-1 justify-center">
            <motion.a
              ...
              className="text-sm xl:text-base font-medium text-gray-700 hover:text-[#d5233b] relative group px-3 py-2 transition-colors duration-200"
              whileHover={{ y: -2 }}
      ...
      <main className="flex-1 w-full">
        {/* Hero Section */}
        <section className="w-full py-6 sm:h-150 sm:py-8 lg:py-18 bg-gradient-to-br from-gray-50 via-red-50/30 to-white">
            ...
            <div className="grid gap-6 lg:gap-12 lg:grid-cols-2 items-center max-w-7xl mx-auto">
              ...
              >
                <div className="space-y-3">
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tight text-gray-900 leading-tight">
                    Unified GPS Platform for{" "}
                    <span className="text-[#d5233b]">Mahindra Logistics</span>
                  </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  ...
                  <Button
                    ...
                    size="lg"
                    onClick={scrollToSection('features')}
                    className="px-6 py-2.5 text-base border-gray-300 text-gray-700 hover:bg-gray-50 rounded-lg font-medium transition-all duration-200 w-full sm:w-auto"
                  >
                    Learn More
                  </Button>
                </div>
              ...
              >
                <div className="relative aspect-[4/3] w-full max-w-xl mx-auto overflow-hidden rounded-2xl bg-white shadow-2xl border border-gray-200">
        ...
        {/* Features Section */}
        <section id="features" className="w-full sm:h-200 py-12 lg:py-16 bg-white">
          <div className="w-full px-4 lg:px-6">
            <div className="max-w-7xl mx-auto">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-red-100 text-red-700 text-sm font-medium mb-4">
              ...
              <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {[
                  ...
                  <motion.div
                    key={feature.title}
                    className="group relative bg-white border border-gray-200 rounded-xl p-4 lg:p-6 shadow-sm hover:shadow-xl transition-all duration-300"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <div className="flex flex-col items-center text-center space-y-3">
                      <div className="w-12 h-12 bg-red-100 rounded-xl flex items-center justify-center group-hover:bg-[#d5233b] transition-colors duration-300">
                        <feature.icon className="h-6 w-6 text-[#d5233b] group-hover:text-white transition-colors duration-300" />
                      </div>
        ...
        {/* Benefits Section */}
        <section id="benefits" className="w-full py-12 lg:py-16 bg-gray-50">
          <div className="w-full px-4 lg:px-6">
            <div className="max-w-7xl mx-auto">
              <div className="grid gap-8 lg:gap-16 lg:grid-cols-2 items-center">
                ...
                >
                  <div className="space-y-3">
                    <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-green-100 text-green-700 text-sm font-medium">
        ...
        <section id="how-it-works" className="w-full py-12 sm:h-150 lg:py-16 bg-white">
          <div className="w-full px-4 lg:px-6">
            <div className="max-w-7xl mx-auto">
              <motion.div
                className="text-center max-w-3xl mx-auto mb-10 lg:mb-14"
                ...
                viewport={{ once: true }}
              >
                <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-purple-100 text-purple-700 text-sm font-medium mb-4">
              ...
              <div className="grid gap-6 md:gap-8 md:grid-cols-3 relative">
                {/* Connection Lines */}
                <div className="hidden md:block absolute top-20 left-1/2 w-full h-0.5 bg-gradient-to-r from-red-200 via-red-300 to-red-200 transform -translate-x-1/2 -translate-y-1/2" />
                ...
                {[
                  ...
                  <motion.div
                    key={step.step}
                    className="relative flex flex-col items-center text-center space-y-4 bg-white border border-gray-200 rounded-xl p-4 lg:p-6 shadow-sm hover:shadow-xl transition-all duration-300"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* Footer */}
      <footer className="w-full border-t border-gray-200 bg-gray-50 py-6 lg:py-8 sm:py-12">
        <div className="w-full px-4 lg:px-6">
          <div className="grid gap-6 md:grid-cols-3 items-center mx-auto">
            <div className="flex items-center gap-3 justify-center md:justify-start">
              <img src={Logo1} alt="Logo" className="w-10 h-10" />
              <span className="text-lg font-bold text-gray-900">M-GPS</span>
            </div>
            ...
            <div className="flex gap-4 justify-center md:justify-end">
              <Link to="#" className="text-sm font-medium text-gray-600 hover:text-[#d5233b] transition-colors duration-200">
                Privacy Policy
              </Link>
              <Link to="#" className="text-sm font-medium text-gray-600 hover:text-[#d5233b] transition-colors duration-200">
                Terms of Service
