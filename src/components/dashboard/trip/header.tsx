              ...
              <div className="relative">
                ...
                {openVehicleGroup && (
                  ...
                  >
                    ...
                    >
                      <Check className={`h-4 w-4 ${!(filters.vehicleGroup as string[])?.length ? "text-green-500" : "invisible"}`} />
                      All Groups
                    </button>
                    {vehicleGroups.map((group) => (
                      ...
                      >
                        <Check className={`h-4 w-4 ${(filters.vehicleGroup as string[]).includes(group.group_id.toString()) ? "text-green-500" : "invisible"}`} />
                        {group.group_name}
                      </button>
                    ))}
                  </motion.div>
              ...
              <div className="relative">
                ...
                {openCustomerGroup && (
                  ...
                  >
                    ...
                    >
                      <Check className={`h-4 w-4 ${!(filters.customerGroup as string[])?.length ? "text-green-500" : "invisible"}`} />
                      All Customer Groups
                    </button>
                    {customerGroups.map((group) => (
                      ...
                      >
                        <Check className={`h-4 w-4 ${(filters.customerGroup as string[]).includes(group.id.toString()) ? "text-green-500" : "invisible"}`} />
                        {group.group_name}
                      </button>
                    ))}
                  </motion.div>
              ...
              <div className="relative">
                ...
                {openCustomerName && (
                  ...
                  >
                    ...
                    >
                      <Check className={`h-4 w-4 ${!(filters.customerName as string[])?.length ? "text-green-500" : "invisible"}`} />
                      All Customers
                    </button>
                    {customerNames.map((customer) => (
                      ...
                      >
                        <Check className={`h-4 w-4 ${(filters.customerName as string[]).includes(customer.customer_name) ? "text-green-500" : "invisible"}`} />
              ...
              <div className="relative">
                ...
                {openVehicleStatus && (
                  ...
                  >
                    ...
                    >
                      <Check className={`h-4 w-4 ${!(filters.vehicleStatus as string[])?.length ? "text-green-500" : "invisible"}`} />
                      All Status
                    </button>
                    {["Active", "No Update", "No Data"].map((status) => (
                      ...
                      >
                        <Check className={`h-4 w-4 ${(filters.vehicleStatus as string[]).includes(status) ? "text-green-500" : "invisible"}`} />
                        {status}
                      </button>
                    ))}
                  </motion.div>
        ...
        >
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Apply Filter Button - right of date range, black color */}
              <Button
                variant="default"
