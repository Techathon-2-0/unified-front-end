  ...
  useEffect(() => {
    ...
    if (isPlaying) {
      ...
      interval = setInterval(() => {
        setCurrentPointIndex(
          currentPointIndex >= trailPoints.length - 1
            ? currentPointIndex
            : currentPointIndex + 1
        )
  ...
  return (
    <div className="w-full h-full min-h-[300px] relative">
      ...
      <div className="absolute right-4 top-1/2 -translate-y-1/2 flex flex-col gap-2 z-20">
        <motion.button
          whileTap={{ scale: 0.95 }}
          className="w-10 h-10 bg-white dark:bg-gray-800 rounded-md shadow-md flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-200"
