...
import type { FeatureSection, ResponsibilityModalProps } from "../../../types/usermanage/responsibilities"
import { availableReports } from "../../../data/usermanage/responsibilities"
              ...
              <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-200px)] pb-20 sm:pb-6">
                {activeSection === "basic" && (
                  ...
                  >
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="text-sm font-medium text-gray-700 mb-2">Profile Summary</h3>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <span className="text-gray-500">Reports Selected:</span>
                          <span className="ml-2 font-medium text-black">{getReportsCount()}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">Tabs Access:</span>
                          <span className="ml-2 font-medium text-black">{getTabsAccessCount()}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">Total Features:</span>
                          <span className="ml-2 font-medium text-black">{getTotalFeatureCount()}</span>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="flex flex-col lg:flex-row gap-6">
                      <div className="w-full lg:w-1/4">
                        <h3 className="text-sm font-semibold mb-4 text-gray-700">Access Categories</h3>
                            ...
                            <motion.button
                              ...
                              className={`w-full text-left px-4 py-3 rounded-lg transition-colors text-sm ${
                                activeCategory === section.id
                                  ? "bg-gray-50 text-black font-medium border border-gray-200"
                      ...
                      <div className="w-full lg:w-3/4">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 mb-4">
                          <h2 className="text-lg font-semibold text-gray-900">{activeFeatureSection.name}</h2>
                          <div className="flex items-center space-x-2">
                            <Button
                              variant="outline"
                              size="sm"
                              className="text-black border-gray-200 hover:bg-gray-50 hover:text-gray-800 text-xs"
                            ...
                            {activeFeatureSection.features.map((feature) => (
                              ...
                              >
                                ...
                                <Label
                                  ...
                                  className="font-medium cursor-pointer text-gray-800 text-sm flex-1"
                                >
                                  {feature.name}
                                </Label>
                              </motion.div>
                ...
                {activeSection === "tabsAccess" && (
                  <motion.div
                    ...
                    className="space-y-6"
                  >
                    <h2 className="text-lg font-semibold text-gray-900 mb-4">Tabs Access Configuration</h2>
                    <ScrollArea className="h-[400px]">
                      <div className="space-y-6">
                        {/* View Only Tabs */}
                        <div>
                          <h3 className="text-md font-medium text-gray-800 mb-3">View Only Tabs</h3>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {[
                              ...
                              <motion.div
                                ...
                                className={`flex items-center space-x-3 p-3 rounded-lg border transition-all ${
                                  tabsAccess[tab.key as keyof typeof tabsAccess]
                        ...
                        {/* Reports Access */}
                        <div>
                          <h3 className="text-md font-medium text-gray-800 mb-3">Reports Access</h3>
                        ...
                        {/* Alarm Access */}
                        <div>
                          <h3 className="text-md font-medium text-gray-800 mb-3">Alarm Access</h3>
                              ...
                              >
                                <div
                                  className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                                    tabsAccess.alarm === option.value ? "border-green-500" : "border-gray-300"
                                  }`}
                                >
                                  {tabsAccess.alarm === option.value && (
                                ...
                                <Label className="font-medium cursor-pointer text-gray-800 text-sm flex-1">
                                  {option.label}
                                </Label>
                              </motion.div>
                            ))}
                        ...
                        {/* Geofence Access */}
                        <div>
                          <h3 className="text-md font-medium text-gray-800 mb-3">Geofence Access</h3>
                          <div className="space-y-4">
                            {[
                                ...
                                <div className="flex gap-2">
                                  {[
                                    ...
                                    <button
                                      ...
                                      className={`px-3 py-1 text-xs rounded-md transition-colors ${
                                        tabsAccess.geofence[item.key as keyof typeof tabsAccess.geofence] ===
                                        option.value
                        ...
                        <div>
                          <h3 className="text-md font-medium text-gray-800 mb-3">User Management Access</h3>
                          <div className="space-y-4">
                            {[
                        ...
                        {/* Manage Access */}
                        <div>
                          <h3 className="text-md font-medium text-gray-800 mb-3">Manage Access</h3>
                          <div className="space-y-4">
                            {[
                                ...
                                <div className="flex gap-2">
                                  {[
                                    ...
                                    <button
                                      ...
                                      className={`px-3 py-1 text-xs rounded-md transition-colors ${
                                        tabsAccess.manage[item.key as keyof typeof tabsAccess.manage] === option.value
